...
status('Forbidden') // => 403
status(306) // throws, as it's not supported by Quiz_angularserver.js
```
...
This is saved so that codes are consistent even in older Quiz_angularserver.js versions.
...
[node-version-image]: http://img.shields.io/badge/Quiz_angularserver.js-%3E%3D_0.6-brightgreen.svg?style=flat
