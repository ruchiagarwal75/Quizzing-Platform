...
status('Forbidden') // => 403
status(306) // throws, as it's not supported by angularserver.js
```
...
This is saved so that codes are consistent even in older angularserver.js versions.
...
[node-version-image]: http://img.shields.io/badge/angularserver.js-%3E%3D_0.6-brightgreen.svg?style=flat
