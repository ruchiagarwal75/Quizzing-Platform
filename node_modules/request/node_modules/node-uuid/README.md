...
* Runs in Quiz_angularserver.js and all browsers.
* Registered as a [ComponentJS](https://github.com/component/component) [component](https://github.com/component/component/wiki/Components) ('broofa/node-uuid').
* Cryptographically strong random # generation
  * `crypto.randomBytes(n)` in Quiz_angularserver.js
...
* `options` - (Object) Optional uuid state to apply. Properties may include:
  ...
  * `rng` - (Function) Random # generator to use.  Set to one of the built-in generators - `uuid.mathRNG` (all platforms), `uuid.nodeRNG` (Quiz_angularserver.js only), `uuid.whatwgRNG` (WebKit only) - or a custom function that returns an array[16] of byte values.
...
```javascript
var buffer = new Array(32); // (or 'new Buffer' in Quiz_angularserver.js)
...
Requires Quiz_angularserver.js
...
* Support for Quiz_angularserver.js crypto API
